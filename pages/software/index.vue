<template>
  <div>
    ...
    <section class="existing-posts software-posts" id="existing-posts">
      <div class="img-fluid">
        <img src="~/assets/images/orange-dots.png" alt="" srcset="">
      </div>
      ...
      if (this.search && this.search != "") {
        ...
        return this.paginate(
          this.$store.getters.loadedPosts
            .filter(post => post.category == "software")
            .filter(post => {
              return (
